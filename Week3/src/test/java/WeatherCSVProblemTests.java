...
public class WeatherCSVProblemTests {
    ...
    public void testColdestHourInFile() {
        ...
        FileResource fr = new FileResource("res/nc_weather/2014/weather-2014-05-01.csv");
    ...
    public void testLowestHumidityInFile() {
        ...
        FileResource fr = new FileResource("res/nc_weather/2014/weather-2014-06-22.csv");
        CSVParser parser = fr.getCSVParser();
    ...
    public void testAverageTemperatureInFile() {
        ...
        FileResource fr = new FileResource("res/nc_weather/2013/weather-2013-08-10.csv");
        CSVParser parser = fr.getCSVParser();
    ...
    public void testAverageTemperatureWithHighHumidityInFile() {
        ...
        FileResource fr = new FileResource("res/nc_weather/2013/weather-2013-09-02.csv");
        CSVParser parser = fr.getCSVParser();
